...
local function GetPlayerList()
    ...
    local playerList = {{
        name = "me", 
        display = LocalPlayer.DisplayName .. " (me)", 
        username = "me"
    }}
...
-- Main Frame (Ukuran lebih kecil & compact)
local MainFrame = Instance.new("Frame")
MainFrame.Name = "MainFrame"
MainFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 30)
MainFrame.BorderSizePixel = 0
MainFrame.Position = UDim2.new(0.5, -135, 0.5, -120)
...
-- BH Toggle Button (DIPINDAHKAN KE PALING ATAS)
...
-- Player Dropdown (DIPINDAHKAN KE BAWAH BUTTON)
local PlayerLabel = Instance.new("TextLabel")
PlayerLabel.Name = "PlayerLabel"
PlayerLabel.BackgroundTransparency = 1
PlayerLabel.Position = UDim2.new(0, 0, 0, 34)
PlayerLabel.Size = UDim2.new(1, 0, 0, 14)
PlayerLabel.Font = Enum.Font.Gotham
PlayerLabel.Text = "Target Player:"
PlayerLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
PlayerLabel.TextSize = 10
PlayerLabel.TextXAlignment = Enum.TextXAlignment.Left
PlayerLabel.Parent = BlackHoleTab

local PlayerDropdown = Instance.new("TextButton")
PlayerDropdown.Name = "PlayerDropdown"
PlayerDropdown.BackgroundColor3 = Color3.fromRGB(40, 40, 45)
...
PlayerDropdown.Parent = BlackHoleTab
...
PlayerList.Position = UDim2.new(0, 8, 0, 142)
PlayerList.Size = UDim2.new(0, 254, 0, 0)
...
BHRadiusLabel.Position = UDim2.new(0, 0, 0, 82)
BHRadiusLabel.Size = UDim2.new(1, 0, 0, 14)
BHRadiusLabel.Font = Enum.Font.Gotham
...
BHRadiusSlider.Position = UDim2.new(0, 0, 0, 98)
...
BHRadiusInput.Position = UDim2.new(0.72, 0, 0, 98)
BHRadiusInput.Size = UDim2.new(0.28, 0, 0, 18)
BHRadiusInput.Font = Enum.Font.Gotham
...
RotSpeedLabel.Position = UDim2.new(0, 0, 0, 122)
RotSpeedLabel.Size = UDim2.new(1, 0, 0, 14)
RotSpeedLabel.Font = Enum.Font.Gotham
...
RotSpeedSlider.Position = UDim2.new(0, 0, 0, 138)
...
RotSpeedInput.Position = UDim2.new(0.72, 0, 0, 138)
RotSpeedInput.Size = UDim2.new(0.28, 0, 0, 18)
RotSpeedInput.Font = Enum.Font.Gotham
...
Tab1Btn.MouseButton1Click:Connect(function()
    ...
    BlackHoleTab.Visible = false
    PlayerList.Visible = false
    PlayerList:TweenSize(UDim2.new(0, 254, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.2, true)
end)
...
local function updatePlayerList(searchTerm)
    ...
    for _, playerData in ipairs(players) do
        local displayText = playerData.display
        if searchTerm == "" or string.find(string.lower(displayText), string.lower(searchTerm)) then
            local btn = Instance.new("TextButton")
            btn.Name = playerData.username
            ...
            btn.MouseButton1Click:Connect(function()
                currentTargetPlayer = GetPlayer(playerData.name)
                PlayerDropdown.Text = displayText .. " ▼"
                PlayerList.Visible = false
                PlayerList:TweenSize(UDim2.new(0, 254, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.2, true)
                if blackHoleActive then
                    togglebh()
...
PlayerDropdown.MouseButton1Click:Connect(function()
    ...
    if PlayerList.Visible then
        updatePlayerList(SearchBox.Text)
        PlayerList:TweenSize(UDim2.new(0, 254, 0, 120), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.2, true)
    else
        PlayerList:TweenSize(UDim2.new(0, 254, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.2, true)
    end
end)
...
BHToggleBtn.MouseButton1Click:Connect(function()
    togglebh()
    BHToggleBtn.Text = blackHoleActive and "BLACKHOLE : AKTIF" or "BLACKHOLE : OFF"
