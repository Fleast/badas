...
local SECONDARY_EMOTE_ID = "93195109588878"
local EMOTE_V2_ID = "70883871260184"
...
-- MAIN FRAME - Ukuran disesuaikan lebih kecil
...
playStopBtn.Size = UDim2.new(1, -20, 0, 30)
playStopBtn.Position = UDim2.new(0, 10, 0, 38)
...
playStopBtn.TextSize = 12
playStopBtn.Parent = mainFrame

local playStopCorner = Instance.new("UICorner", playStopBtn)
playStopCorner.CornerRadius = UDim.new(0, 7)

-- Play/Stop V2 Button
local playStopV2Btn = Instance.new("TextButton")
playStopV2Btn.Size = UDim2.new(1, -20, 0, 30)
playStopV2Btn.Position = UDim2.new(0, 10, 0, 72)
playStopV2Btn.BackgroundColor3 = Color3.fromRGB(25, 30, 40)
playStopV2Btn.BorderSizePixel = 0
playStopV2Btn.Text = "AKTIFKAN GLITCH V2"
playStopV2Btn.TextColor3 = Color3.fromRGB(255, 255, 255)
playStopV2Btn.Font = Enum.Font.GothamBold
playStopV2Btn.TextSize = 12
playStopV2Btn.Parent = mainFrame

local playStopV2Corner = Instance.new("UICorner", playStopV2Btn)
playStopV2Corner.CornerRadius = UDim.new(0, 7)
...
speedLabel.Text = string.format("SPEED GLITCH: %.2f", Settings["Speed"])
...
killAllBtn.Size = UDim2.new(0.48, -5, 0, 28)
killAllBtn.Position = UDim2.new(0.52, 0, 0, 217)
...
killAllCorner.CornerRadius = UDim.new(0, 7)
...
-- Play/Stop Button Logic (DUAL EMOTE - 2 ID SEKALIGUS)
local isPlaying = false

playStopBtn.MouseButton1Click:Connect(function()
    if not isPlaying then
        local id1 = extractIdFromInput(DEFAULT_EMOTE_ID)
        local id2 = extractIdFromInput(SECONDARY_EMOTE_ID)
        
        if id1 and id2 then
            LoadTrack(id1)
            LoadTrack2(id2)
            
            playStopBtn.Text = "MATIKAN GLITCH"
            playStopBtn.TextColor3 = Color3.fromRGB(255, 59, 48)
            isPlaying = true
        end
    else
        StopTrack()
...
-- Play/Stop V2 Button Logic (SINGLE EMOTE)
local isPlayingV2 = false

playStopV2Btn.MouseButton1Click:Connect(function()
    if not isPlayingV2 then
        local id = extractIdFromInput(EMOTE_V2_ID)
        if id then
            LoadTrack(id)
            playStopV2Btn.Text = "MATIKAN GLITCH V2"
            playStopV2Btn.TextColor3 = Color3.fromRGB(255, 59, 48)
            isPlayingV2 = true
        end
    else
        StopTrackV2()
...
minimizeBtn.MouseButton1Click:Connect(function()
    -- Simpan posisi saat ini sebelum minimize
    savedFramePosition = mainFrame.Position
    
    SmoothTween(mainFrame, 0.5, {
        Size = UDim2.new(0, 0, 0, 0),
        Position = UDim2.new(savedFramePosition.X.Scale, savedFramePosition.X.Offset, savedFramePosition.Y.Scale, savedFramePosition.Y.Offset),
...
minimizedBtn.MouseButton1Click:Connect(function()
    ...
    -- Set posisi awal dari posisi yang tersimpan
    mainFrame.Size = UDim2.new(0, 0, 0, 0)
    mainFrame.Position = savedFramePosition
    mainFrame.BackgroundTransparency = 1
    
    -- Buka dengan animasi di posisi yang sama
    SmoothTween(mainFrame, 0.5, {
