...
local function createSIEXTHERHan()
    ...
    -- ADD IMAGEBUTTON INSIDE FLOATING BUTTON
    ...
    floatImage.Image = "rbxassetid://11560341824"
    ...
    -- Button container di bawah (vertical layout)
    local btnContainer = Instance.new("Frame")
    btnContainer.Size = UDim2.new(1, -20, 0, 63)
    btnContainer.Position = UDim2.new(0, 10, 1, -73)
    btnContainer.BackgroundTransparency = 1
    btnContainer.Parent = Frame

    -- Purchase button (sky blue) - TOP
    ...
    -- SPAM BUY button (sky blue) - BOTTOM
    ...
    spamBuy.Size = UDim2.new(1, 0, 0, 28)
    spamBuy.Position = UDim2.new(0, 0, 0, 35)
