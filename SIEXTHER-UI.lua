...
DRR["2"]["Position"] = UDim2.new(0.23000000417232513, 0, -0.005, 0);
DRR["2"]["Name"] = [[TopBar]];
...
function UILIB:Load(name, img, direction)
	...
	task.spawn(function()
		-- TopBar muncul di posisi atas kecil (seperti gambar 2)
		local tw2 = twServ:Create(parent.TopBar, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Position = UDim2.new(0.23, 0, -0.005, 0) })
		tw2:Play()
	end)
        task.spawn(function()
	     while true do
