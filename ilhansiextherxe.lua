...
local colors = {
    ...
    buttonDark = Color3.fromRGB(35, 35, 45), -- Dark button color
}
...
-- Toggle Button (🎮 di luar frame - DARK COLOR & SIZE 44x44)
local toggleButton = Instance.new("TextButton")
toggleButton.Name = "ToggleButton"
toggleButton.Size = UDim2.new(0, 44, 0, 44)
toggleButton.Position = UDim2.new(0, 15, 0.5, -22)
toggleButton.BackgroundColor3 = colors.buttonDark -- DARK COLOR
toggleButton.Text = "🎥"
...
mainFrame.Visible = true -- LANGSUNG MUNCUL
...
-- Recordings List Frame (DI SAMPING KANAN)
