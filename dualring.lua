...
MainFrame.Position = UDim2.new(1, -220, 1, -280)
...
-- 🟥 Tambahan Tombol X (Close Script)
...
CloseButton.MouseButton1Click:Connect(function()
	playSound("177266782")
	ScreenGui:Destroy()
	if getgenv().RingNetwork then
		getgenv().RingNetwork.Active = false
		getgenv().RingNetwork = nil
	end
end)
-- 🟥 Selesai Tambahan Tombol X
...
-- (lanjutan kode kamu tetap sama setelah ini)
...
local function updateRadius(change)
    BASE_RADIUS = math.clamp(BASE_RADIUS + change, 2, 100)
