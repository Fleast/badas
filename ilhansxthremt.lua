...
minimizeBall.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
minimizeBall.Text = "HS"
...
-- Buat bola bulat sempurna
createCorner(minimizeBall, 30)

-- Shadow effect untuk bola
local ballShadow = Instance.new("ImageLabel")
ballShadow.Size = UDim2.new(1.2, 0, 1.2, 0)
ballShadow.Position = UDim2.new(-0.1, 0, -0.1, 0)
ballShadow.BackgroundTransparency = 1
ballShadow.Image = "rbxasset://textures/ui/GuiImagePlaceholder.png"
ballShadow.ImageColor3 = Color3.fromRGB(0, 0, 0)
ballShadow.ImageTransparency = 0.7
ballShadow.ZIndex = 998
ballShadow.Parent = minimizeBall
...
-- Minimize button functionality - UPDATED
minimizeBtn.MouseButton1Click:Connect(function()
    ...
    -- Tampilkan bola minimize dengan animasi
...
-- Minimize ball click functionality - Buka kembali window
minimizeBall.MouseButton1Click:Connect(function()
    ...
    closeTween.Completed:Connect(function()
        ...
        -- Tampilkan window utama dengan animasi
