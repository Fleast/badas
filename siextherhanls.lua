...
-- Array random greeting messages
...
-- 2. Frame Utama dengan Modern Dark Background
...
local function createParticle()
    ...
    local endY = math.random(-20, -5) / 100
...
task.spawn(function()
    while particleActive and mainFrame and mainFrame.Parent do
        createParticle()
...
TitleGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),    -- Putih
    ColorSequenceKeypoint.new(0.3, Color3.fromRGB(70, 130, 255)),   -- Sky Blue
    ColorSequenceKeypoint.new(0.6, Color3.fromRGB(70, 130, 255)),   -- Sky Blue
    ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 255, 255))     -- Putih
})
TitleGradient.Offset = Vector2.new(-1, 0)
TitleGradient.Rotation = 0

-- Animasi Gradient Kiri-Kanan
task.spawn(function()
...
local line2 = "Made by Hann.Sxthr"
