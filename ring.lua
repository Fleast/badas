...
-- MATERIAL DARK GUI THEME UPDATE
local Players = game:GetService("Players")
local RunService = game:GetService("RunService")
local UserInputService = game:GetService("UserInputService")
...
-- Main Frame (Material Dark + Transparan)
...
DecreaseRadius.Text = "<"
DecreaseRadius.BackgroundColor3 = Color3.fromRGB(55, 55, 60)
DecreaseRadius.BackgroundTransparency = 0.1
...
IncreaseRadius.Text = ">"
IncreaseRadius.BackgroundColor3 = Color3.fromRGB(55, 55, 60)
IncreaseRadius.BackgroundTransparency = 0.1
...
RadiusDisplay.Text = "Radius: 10"
RadiusDisplay.BackgroundColor3 = Color3.fromRGB(55, 55, 60)
...
-- Tambahan tombol Close (X) di sebelah tombol minimize
...
CloseButton.MouseButton1Click:Connect(function()
    playSound("12221967") -- efek klik
    -- Hapus GUI
    ScreenGui:Destroy()
    -- Hentikan semua event dan logic
    ringPartsEnabled = false
    parts = {}
    print("[Super Ring Part] Script stopped and GUI closed.")
end)

-- Minimize button (Material floating icon)
...
local userId = Players:GetUserIdFromNameAsync("HannSykess")
